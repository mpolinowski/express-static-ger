...
.get(function(req, res) {
  res.render('./Indoor_Cams/IN-8015_Overview', {
      ...
      description: 'Die IN-8015 Full HD (1080p, 2 Megapixel Auflösung) IP Überwachungskamera, IP Webcam, PTZ Webcam bietet Infrarot Nachtsicht, WLAN und LAN Anbindung, drahtlose Videoübertragung, einen Netzwerkstream über RTSP und eine kostenlose P2P und DDNS Adresse für den Fernzugriff. Überwachen Sie Ihr Haus, Auto, Haustier, Baby und vieles mehr mit einer der besten Sicherheitskamera auf dem Markt.',
		  pacc: '',
		  qiacc: '',
		  mdacc: '',
		  iaacc: '',
...
.get(function(req, res) {
  res.render('./Indoor_Cams/IN-6014_Overview', {
      ...
      description: 'Die IN-6014 HD (720p, 1 Megapixel Auflösung) IP Überwachungskamera, IP Webcam, PTZ Webcam bietet Infrarot Nachtsicht, WLAN und LAN Anbindung, drahtlose Videoübertragung, einen Netzwerkstream über RTSP und eine kostenlose P2P und DDNS Adresse für den Fernzugriff. Überwachen Sie Ihr Haus, Auto, Haustier, Baby und vieles mehr mit einer der besten Sicherheitskamera auf dem Markt.',
		  pacc: '',
		  qiacc: '',
		  mdacc: '',
		  iaacc: '',
...
.get(function(req, res) {
  res.render('./Indoor_Cams/IN-6012_Overview', {
      ...
      description: 'Die IN-6012 HD (720p, 1 Megapixel Auflösung) IP Überwachungskamera, IP Webcam, PTZ Webcam bietet Infrarot Nachtsicht, WLAN und LAN Anbindung, drahtlose Videoübertragung, einen Netzwerkstream über RTSP und eine kostenlose P2P und DDNS Adresse für den Fernzugriff. Überwachen Sie Ihr Haus, Auto, Haustier, Baby und vieles mehr mit einer der besten Sicherheitskamera auf dem Markt.',
		  pacc: '',
		  qiacc: '',
		  mdacc: '',
		  iaacc: '',
...
.get(function(req, res) {
  res.render('./Indoor_Cams/IN-6001_Overview', {
      ...
      description: 'Die IN-6001 Full HD (720p, 1 Megapixel Auflösung) IP Überwachungskamera, IP Webcam, PTZ Webcam bietet Infrarot Nachtsicht, WLAN und LAN Anbindung, drahtlose Videoübertragung, einen Netzwerkstream über RTSP und eine kostenlose P2P und DDNS Adresse für den Fernzugriff. Überwachen Sie Ihr Haus, Auto, Haustier, Baby und vieles mehr mit einer der besten Sicherheitskamera auf dem Markt.',
		  pacc: '',
		  qiacc: '',
		  mdacc: '',
		  iaacc: '',
...
.get(function(req, res) {
  res.render('./Indoor_Cams/IN-3011_Overview', {
      ...
      description: 'Die IN-3011 VGA (640x480 Auflösung) IP Überwachungskamera, IP Webcam, PTZ Webcam bietet Infrarot Nachtsicht, WLAN und LAN Anbindung, drahtlose Videoübertragung, einen Netzwerkstream über RTSP und eine kostenlose DDNS Adresse für den Fernzugriff. Überwachen Sie Ihr Haus, Auto, Haustier, Baby und vieles mehr mit einer der besten Sicherheitskamera auf dem Markt.',
		  pacc: '',
		  qiacc: '',
		  mdacc: '',
		  iaacc: '',
