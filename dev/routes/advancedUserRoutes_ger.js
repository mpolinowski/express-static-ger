...
advancedUserGerRouter.get('/', function(req, res) {
    res.render('./Advanced_User/Advanced_User', {
        title: 'Themen für Entwickler',
        ampimg: '/images/Search/AU_SearchThumb_ForDeveloper.jpg',
        headline: 'Webseiteneinbindung, CGI Programmier-Interface und wiederherstellen beschädigter Kamerasoftware',
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Erweitert/">Erweitert</a></li>',
        canonical: '/Advanced_User/',
        description: 'Webseiteneinbindung, CGI Programmier-Interface und wiederherstellen beschädigter Kamerasoftware',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
...
advancedUserGerRouter.get('/Webseiten_Einbindung/', function(req, res) {
    res.render('./Advanced_User/Website_Integration', {
        title: 'INSTAR IP Kamera Webseiten Einbindung',
        ampimg: '/images/Search/AU_SearchThumb_WebsiteIntegration.jpg',
        headline: 'Verwenden Sie Ihre IP Kamera als Webcam und binden Sie Ihre Kamera in Ihre Webseite ein',
        ...
        description: 'Fügen Sie das Live Video Ihrer Kamera in Ihre Webseite ein. Oder laden Sie Einzelbilder auf Ihren Webserver und binden Sie diese auf Ihrer Seite ein.',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
...
advancedUserGerRouter.get('/Webseiten_Einbindung/Cambozola', function(req, res) {
    res.render('./Advanced_User/Cambozola', {
        ...
        description: 'Fügen Sie das Live Video Ihrer Kamera mit Hilfe des JAVA Plugins Cambozola in Ihre Webseite ein.',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
...
advancedUserGerRouter.get('/Webseiten_Einbindung/Open_IP_Camera_Manager', function(req, res) {
    res.render('./Advanced_User/Open_IP_Camera_Manager', {
        ...
        description: 'Fügen Sie das Live Video Ihrer Kamera mit Hilfe des PHP Plugins Open IP Camera Manager in Ihre Webseite ein.',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
...
advancedUserGerRouter.get('/Webseiten_Einbindung/HD_Kamera_Einbindung', function(req, res) {
    res.render('./Advanced_User/HD_Camera_Integration', {
        ...
        description: 'Fügen Sie das Live Video Ihrer HD Kamera mit Hilfe unseres HTML Templates in Ihre Webseite ein.',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
...
advancedUserGerRouter.get('/CGI_Befehle/', function(req, res) {
    res.render('./Advanced_User/CGI_Commands', {
        title: 'CGI Befehle für die Steuerung Ihrer INSTAR IP Kamera',
        ampimg: '/images/Search/AU_SearchThumb_CGICommands.jpg',
        headline: 'Nutzen Sie unsere CGI Programmierschnittstelle um direkt alle Funktionen auf der Kamera anzusprechen.',
        ...
        description: 'Mit CGI Befehle können Sie direkt über die Addresszeile Ihres Browsers, oder eingebunden in Ihre Webseite, Funktionen auf der Kamera aktivieren und Werte setzen. Alle Funktionen der INSTAR Weboberfläche sind hier in Form von Kommandos verfügbar.',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
...
advancedUserGerRouter.get('/WebUI_Wiederherstellen/', function(req, res) {
    res.render('./Advanced_User/Restore_WebUI', {
        ...
        description: 'Sollte beim Aktualisieren der Weboberfläche ein Fehler aufgetreten sein, können Sie diese ohne Probleme mit unserem Kamera Tool oder unserem Simple Update Tool erneut aufspielen.',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
...
advancedUserGerRouter.get('/Firmware_Wiederherstellen/', function(req, res) {
    res.render('./Advanced_User/Restore_Firmware', {
        ...
        description: 'Reagiert Ihre HD Kamera nicht mehr nach einem fehlgeschlagenen Firmware Update? Lernen Sie hier wie Sie die Software wieder herstellen. Profiwissen benötigt!',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
...
advancedUserGerRouter.get('/Firmware_Wiederherstellen/VGA_Modelle', function(req, res) {
    res.render('./Advanced_User/Restore_Firmware_VGA', {
        ...
        description: 'Reagiert Ihre VGA Kamera nicht mehr nach einem fehlgeschlagenen Firmware Update? Lernen Sie hier wie Sie die Software wieder herstellen. Profiwissen benötigt!',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
...
advancedUserGerRouter.get('/CCTV_vs_IP/', function(req, res) {
    res.render('./Advanced_User/CCTV_vs_IP', {
        ...
        description: 'Wenn Sie sich über Überwachungskameras informieren, werden Sie über die Diskussion stolpern - benötigt man eine IP oder Analogkamera?',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
...
advancedUserGerRouter.get('/VPN_AVM_Fritzbox/', function(req, res) {
    res.render('./Advanced_User/VPN_AVM_Fritzbox_Windows', {
        ...
        headline: 'Virtual Private Network für den Fernzugriff auf Ihre INSTAR IP Kamera',
        ...
        description: 'Vermeiden Sie das Öffnen eines Ports an Ihrer AVM Fritzbox, indem Sie ein virtuelles, privates Netzwerk für den Fernzugriff nutzen.',
    		pacc: '',
    		ptab: 'hidden',
    		qiacc: '',
    		qitab: 'hidden',
