...
downloadsGerRouter.get('/Innenkameras/', function(req, res) {
    res.render('./Downloads/Indoor_Cameras', {
        ...
        ampimg: '/images/P_SearchThumb_Produkte.jpg',
        headline: 'Download Bereich',
...
downloadsGerRouter.get('/Zubeh%F6r/IN-90x', function(req, res) {
    res.render('./Downloads/Accessories_IN-90x', {
        ...
        ampimg: '/images/P_SearchThumb_Products.jpg',
        headline: 'Download Bereich',
        breadcrumbs: '<li class="breadcrumb-item"><a href="/">Home</a></li><li class="breadcrumb-item"><a href="/Downloadbereich/">Downloadbereich</a></li><li class="breadcrumb-item"><a href="/Downloadbereich/Zubeh%F6r/">Zubehör</a></li><li class="breadcrumb-item"><a href="/Downloadbereich/Zubeh%F6r/IN-90x">IN-903 & IN-905</a></li>',
		pacc: '',
		ptab: 'hidden',
		qiacc: '',
		qitab: 'hidden',
