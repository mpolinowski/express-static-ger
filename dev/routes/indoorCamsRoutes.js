...
.get(function(req, res) {
  res.render('./Indoor_Cams/IN-8015_Tech_Specs', {
      ...
      ampimg: '/images/Search/P_SearchThumb_Indoor_Cameras.jpg',
      headline: 'INSTAR Products Indoor IP Cameras',
      breadcrumbs: '<li class="breadcrumb-item"><a href="/Products">Products</a></li><li class="breadcrumb-item"><a href="/Indoor_Cameras/">Indoor Cameras</a></li><li class="breadcrumb-item"><a href="/Indoor_Cameras/IN-8015_HD/">IN-8015 HD</a></li><li class="breadcrumb-item"><a href="/Indoor_Cameras/IN-8015_HD/Technical_Specifications/">Technical Specifications</a></li>',
		  pacc: '',
		  qiacc: '',
		  mdacc: '',
		  iaacc: '',
...
.get(function(req, res) {
  res.render('./Indoor_Cams/IN-6014_Tech_Specs', {
      ...
      ampimg: '/images/Search/P_SearchThumb_Indoor_Cameras.jpg',
      headline: 'INSTAR Products Indoor IP Cameras',
      breadcrumbs: '<li><a href="/Products">Products</a></li><li><a href="/Indoor_Cameras/">Indoor Cameras</a></li><li><a href="/Indoor_Cameras/IN-6014_HD/">IN-6014 HD</a></li><li><a href="/Indoor_Cameras/IN-6014_HD/Technical_Specifications/">Technical Specifications</a></li>',
		  pacc: '',
		  qiacc: '',
		  mdacc: '',
		  iaacc: '',
...
.get(function(req, res) {
  res.render('./Indoor_Cams/IN-6012_Tech_Specs', {
      ...
      ampimg: '/images/Search/P_SearchThumb_Indoor_Cameras.jpg',
      headline: 'INSTAR Products Indoor IP Cameras',
      breadcrumbs: '<li><a href="/Products">Products</a></li><li><a href="/Indoor_Cameras/">Indoor Cameras</a></li><li><a href="/Indoor_Cameras/IN-6012_HD/">IN-6012 HD</a></li><li><a href="/Indoor_Cameras/IN-6012_HD/Technical_Specifications/">Technical Specifications</a></li>',
		  pacc: '',
		  qiacc: '',
		  mdacc: '',
		  iaacc: '',
...
.get(function(req, res) {
  res.render('./Indoor_Cams/IN-6001_Tech_Specs', {
      ...
      ampimg: '/images/Search/P_SearchThumb_Indoor_Cameras.jpg',
      headline: 'INSTAR Products Indoor IP Cameras',
      breadcrumbs: '<li><a href="/Products">Products</a></li><li><a href="/Indoor_Cameras/">Indoor Cameras</a></li><li><a href="/Indoor_Cameras/IN-6001_HD/">IN-6001 HD</a></li><li><a href="/Indoor_Cameras/IN-6001_HD/Technical_Specifications/">Technical Specifications</a></li>',
		  pacc: '',
		  qiacc: '',
		  mdacc: '',
		  iaacc: '',
