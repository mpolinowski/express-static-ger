...
quickInstallGerRouter.route('/WebUI_und_Firmware_Upgrade')
    .get(function(req, res) {
        res.render('./Quick_Installation/WebUI_And_Firmware_Upgrade', {
            ...
            description: 'INSTAR arbeitet ständig an Verbesserungen und Erweiterungen der Full HD Kamersoftware. Es empfiehlt sich daher regelmäßig zu prüfen, ob ein Update verfügbar ist und dieses umgehend aufzuspielen.',
      			pacc: '',
      			ptab: 'hidden',
      			qiacc: 'expanded',
      			qitab: '',
...
quickInstallGerRouter.route('/WebUI_und_Firmware_Upgrade/720p_Kameras')
    .get(function(req, res) {
        res.render('./Quick_Installation/WebUI_And_Firmware_Upgrade_HD', {
            ...
            description: 'INSTAR arbeitet ständig an Verbesserungen und Erweiterungen der HD Kamersoftware. Es empfiehlt sich daher regelmäßig zu prüfen, ob ein Update verfügbar ist und dieses umgehend aufzuspielen.',
      			pacc: '',
      			ptab: 'hidden',
      			qiacc: 'expanded',
      			qitab: '',
...
quickInstallGerRouter.route('/WebUI_und_Firmware_Upgrade/VGA_Kameras')
    .get(function(req, res) {
        res.render('./Quick_Installation/WebUI_And_Firmware_Upgrade_VGA', {
            ...
            description: 'INSTAR arbeitet ständig an Verbesserungen und Erweiterungen der VGA Kamersoftware. Es empfiehlt sich daher regelmäßig zu prüfen, ob ein Update verfügbar ist und dieses umgehend aufzuspielen.',
      			pacc: '',
      			ptab: 'hidden',
      			qiacc: 'expanded',
      			qitab: '',
