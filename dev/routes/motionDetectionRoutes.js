...
motionDetectionRouter.get('/Setup/', function(req, res) {
    res.render('./Motion_Detection/Motion_Detection_Setup', {
        ...
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/Setup/">Installation</a></li>',
      });
  });
...
motionDetectionRouter.get('/Alarm_Notification/', function(req, res) {
    res.render('./Motion_Detection/Alarm_Notification', {
        ...
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/Alarm_Notification/">Alarm Benachrichtigung</a></li>',
      });
  });
...
motionDetectionRouter.get('/Alarm_Notification/SMTP_Servers', function(req, res) {
    res.render('./Motion_Detection/Alarm_Notification_SMTP_Servers', {
        ...
        uplink: '/Motion_Detection',
        ampimg: '/images/Search/MD_SearchThumb_AlarmNotification.jpg',
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/Alarm_Notification/">Alarm Notification</a></li><li><a href="/Motion_Detection/Alarm_Notification/SMTP_Servers/">SMTP Server</a></li>',
      });
  });
...
motionDetectionRouter.get('/Cloud/Create_User_Account', function(req, res) {
    res.render('./Motion_Detection/Cloud_Create_User_Account', {
        ...
        ampimg: '/images/Search/MD_SearchThumb_Cloud.jpg',
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/INSTAR_Cloud/">INSTAR Cloud</a></li><li><a href="/Motion_Detection/INSTAR_Cloud/Create_User_Account/">Neuen Benutzer erstellen</a></li>',
      });
  });
  ...
  motionDetectionRouter.get('/Cloud/Get_More_Cloudstorage', function(req, res) {
    res.render('./Motion_Detection/Cloud_Get_More_Cloudstorage', {
        ...
        uplink: '/Motion_Detection/Cloud',
        ampimg: '/images/Search/MD_SearchThumb_Cloud.jpg',
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/INSTAR_Cloud/">INSTAR Cloud</a></li><li><a href="/Motion_Detection/INSTAR_Cloud/Storage/">Speicherplatz</a></li>',
      });
  });
  ...
  motionDetectionRouter.get('/Cloud/User', function(req, res) {
    res.render('./Motion_Detection/Cloud_User', {
        ...
        uplink: '/Motion_Detection/Cloud',
        ampimg: '/images/Search/MD_SearchThumb_Cloud.jpg',
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/INSTAR_Cloud/">INSTAR Cloud</a></li><li><a href="/Motion_Detection/INSTAR_Cloud/User/">Benutzer</a></li>',
      });
  });
  ...
  motionDetectionRouter.get('/Cloud/Alarm', function(req, res) {
    res.render('./Motion_Detection/Cloud_Alarm', {
        ...
        uplink: '/Motion_Detection/Cloud',
        ampimg: '/images/Search/MD_SearchThumb_Cloud.jpg',
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/INSTAR_Cloud/">INSTAR Cloud</a></li><li><a href="/Motion_Detection/INSTAR_Cloud/Alarm_Recordings/">Alarm Aufnahmen</a></li>',
      });
  });
  ...
  motionDetectionRouter.get('/Cloud/Settings', function(req, res) {
    res.render('./Motion_Detection/Cloud_Settings', {
        ...
        uplink: '/Motion_Detection/Cloud',
        ampimg: '/images/Search/MD_SearchThumb_Cloud.jpg',
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/INSTAR_Cloud/">INSTAR Cloud</a></li><li><a href="/Motion_Detection/INSTAR_Cloud/Camera_Sets/">Kamera Sets</a></li>',
      });
  });
...
motionDetectionRouter.get('/Alarm_Recording/', function(req, res) {
    res.render('./Motion_Detection/Alarm_Recording', {
        ...
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/Alarm_Recording/">Alarm Aufnahme</a></li>',
      });
  });
...
motionDetectionRouter.get('/SD_Card_Access/', function(req, res) {
    res.render('./Motion_Detection/SD_Card_Access', {
        ...
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/SD_Card_Access/">Zugriff auf SD-Karte</a></li>',
      });
  });
...
motionDetectionRouter.get('/Router_as_a_FTP_Server/', function(req, res) {
    res.render('./Motion_Detection/Router_as_a_FTP_Server', {
        ...
        breadcrumbs: '<li><a href="/">Home</a></li><li><a href="/Motion_Detection/">Motion Detection</a></li><li><a href="/Motion_Detection/Router_as_a_FTP_Server/">Router als FTP Server</a></li>',
      });
  });
